...
function Masthead({ resource }: { resource: Resource }) {
  return (
    <CmsMasthead
      steveId={resource.previewContentResourceId ?? undefined}
    ...
    >
      ...
      <span className="text-dimmed">
        ...
        {resource.viewCount !== null && resource.viewCount !== undefined && (
...
function ResourceView({
  ...
  const externalUrl =
    resource.downloadUrl && /^https?:\/\//iu.test(resource.downloadUrl)
