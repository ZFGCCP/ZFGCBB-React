...
export default function UserAccountSettingsRoute() {
  ...
  const storeDeletionState = (state?: AccountDeletionState) => {
        ...
        <div className="p-4 space-y-4">
          ...
          {deletionUnderway && (
            <div className="space-y-2">
              <p className="font-bold text-error">
                This account&apos;s deletion has been confirmed and is being
                carried out.
              </p>
              <p className="text-sm text-dimmed">
          ...
          {!deletionUnderway && pendingDeletion && (
            <div className="space-y-3">
              ...
              <p className="text-xs text-dimmed">
                Didn&apos;t request this? Cancel it now and change your
                password.
              </p>
            </div>
          )}
          ...
          {!deletionUnderway && !pendingDeletion && stage === "verify" && (
            <div className="space-y-4 max-w-md">
              ...
              <p className="text-sm">
                Confirm it&apos;s really you. Nothing is deleted yet — after
                this step we email you a confirmation link, and the deletion
                only happens once you open it.
              </p>
              <BBForm
                form={verifyForm}
                errorMessage={
